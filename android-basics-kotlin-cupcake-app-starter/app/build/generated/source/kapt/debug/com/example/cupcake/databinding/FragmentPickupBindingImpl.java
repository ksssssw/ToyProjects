...
public class FragmentPickupBindingImpl extends FragmentPickupBinding implements com.example.cupcake.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x18L) != 0) {
            ...
            this.option0.setText(viewModelDateOptions0);
            this.option1.setText(viewModelDateOptions1);
            this.option2.setText(viewModelDateOptions2);
            this.option3.setText(viewModelDateOptions3);
        }
        if ((dirtyFlags & 0x19L) != 0) {
            // api target 1

            this.subtotal.setText(subtotalAndroidStringSubtotalPriceViewModelPrice);
        }
    }
