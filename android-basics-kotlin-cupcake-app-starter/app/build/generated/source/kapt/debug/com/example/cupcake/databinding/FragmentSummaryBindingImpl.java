...
public class FragmentSummaryBindingImpl extends FragmentSummaryBinding implements com.example.cupcake.generated.callback.OnClickListener.Listener {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.quantity_label, 7);
        sViewsWithIds.put(R.id.divider1, 8);
        sViewsWithIds.put(R.id.flavor_label, 9);
        sViewsWithIds.put(R.id.divider2, 10);
        sViewsWithIds.put(R.id.pickup_label, 11);
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x40L) != 0) {
            ...
            this.sendButton.setOnClickListener(mCallback17);
        }
        if ((dirtyFlags & 0x62L) != 0) {
            // api target 1

            this.date.setText(viewModelDateGetValue);
        }
        if ((dirtyFlags & 0x68L) != 0) {
            // api target 1

            this.flavor.setText(viewModelFlavorGetValue);
        }
        if ((dirtyFlags & 0x64L) != 0) {
            // api target 1

            this.quantity.setText(viewModelQuantityToString);
        }
        if ((dirtyFlags & 0x61L) != 0) {
            // api target 1

            this.total.setText(totalAndroidStringTotalPriceViewModelPrice);
        }
    }
